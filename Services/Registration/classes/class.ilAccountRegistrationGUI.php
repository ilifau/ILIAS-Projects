...
// fim: ili: fau: regCodes - always inclode the code class
...
// fim: ili: fau: regCodes - class variables
...
// fim: ili: fau: regCodes - initialize an already entered code and save in settings
	...
	public function executeCommand()
	{
		...
		switch($next_class)
		{
			default:
				...
				{
// fim: ili: fau: regCodes - determine default command based on code entry
					if (!$this->code_enabled)
					{
						$this->displayForm();
					}
...
// fim: ili: fau: regCodes - handle separate form for code entry
...
// fim. ili. fau.
	...
	public function displayForm()
	{
		...
		ilStartUpGUI::initStartUpTemplate(array('tpl.usr_registration.html', 'Services/Registration'), true);
// fim: ili: fau: regCodes - show customized title and headline of registration code
...
// fim. ili. fau.
	...
	protected function __initForm()
	{
		...
		// #14272
// fim: ili: fau: regCodes - check for registration type and code to set email required
...
// fim: ili: fau: regCodes - use code setting for captcha display
...
// fim. ili. fau.
	...
	public function saveForm()
	{
		...
		if($this->code_enabled)
		{
// fim: ili: fau: regCodes - take the code object instead of form input
			// could be optional
			if($this->codeObj)
			{
...
// fim: ili: fau: regCodes - use login generation types
...
// fim: ili: fau: regCodes - take the code object instead of form input
	...
	//fim: ili: fau: RegCodes - add startref
...
// fim: ili: fau: regCodes - check with code for activation
		if($this->registration_settings->activationEnabled())
		{
...
// fim: ili: fau: regCodes - save used registration code in preferences
        if ($this->codeObj)
        {
...
// fim: ili: fau: regCodes - new function __generateLogin
...
// fim: ili: fau: regCodes - extended check for enabled activation (code or gloval)
        if($this->registration_settings->activationEnabled())
// fim. ili. fau.
		{
