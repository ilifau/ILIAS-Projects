...
// fim: ili: fau: regCodes - new constants for login generation
...
// fim: ili: fau: regCodes - variable for code object
...
// fim: ili: fau: regCodes - new function getInstance
...
// fim. ili. fau.
// fim: ili: fau: regCodes - new function setCodeObject
	/**
...
// fim. ili. fau.
// fim: ili: fau: regCodes - new function getLoginGenerationTypes
	/**
...
// fim. ili. fau.
// fim: ili: fau: regCodes - new function loginGenerationType
	/**
...
// fim. ili. fau.
	...
	{
// fim: ili: fau: regCodes - take code settings for email verification with precedence
		if (isset($this->codeObj))
		{
...
// fim. ili. fau.
	...
	{
// fim: ili: fau: regCodes - take code settings for password generation with precedence
		if (isset($this->codeObj))
		{
...
// fim. ili. fau.
	...
	{
// fim: ili: fau: regCodes - take the code settings for approve recipients with precedence
		if (isset($this->codeObj))
		{
...
// fim. ili. fau.
	...
	{
// fim: ili: fau: regCodes - don't restrict email domains with a code
		if (isset($this->codeObj))
		{
			return array();
		}
