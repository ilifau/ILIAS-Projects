...
// fim: ili: fau: regCodes - phpdoc for form_gui
...
// fim: ili: fau: regCodes - change initAddCodesForm to initCodesForm and extend it
	/**
...
// fim: ili: fau: regCodes - new function validateCodesForm
...
// fim: ili: fau: regCodes - new function writeCodesFormData
	/**
...
// fim: ili: fau: regCodes - init new codes form
...
// fim: ili: fau: regCodes - save the codes through code object
        include_once './Services/Registration/classes/class.ilRegistrationCode.php';
...
// fim: ili: fau: regCodes - new function editCode
            function editCode()
            {
                global $ilAccess, $ilErr;
                if(!$ilAccess->checkAccess('write', '', $this->ref_id))
...
// fim: ili: fau: regCodes - new function updateCode
            function updateCode()
            {
                global $ilAccess, $ilErr, $rbacreview;
                if(!$ilAccess->checkAccess('write', '', $this->ref_id))
